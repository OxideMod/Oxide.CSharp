...
//        public static string DotNet = "dotnet.exe";
...
//                    DownloadName = $"Oxide.Compiler.x{arc}";

//                    if (HasFrameworkInstalled())
//                    {
//                        DownloadName += ".min";
//                    }

//                    DownloadName += ".exe";
//                    FileName = $"Oxide.Compiler.exe";
//                    binaryPath = Path.Combine(rootDirectory, FileName);
//                    DownloadCompiler(binaryPath);
//                    SetCompilerVersion();
//                    break;
...
//        private static void DownloadCompiler(string binary)
//        {
//            try
//            {
                
//                HttpWebRequest request = (HttpWebRequest)WebRequest.Create($"http://s3.us-west-1.amazonaws.com/s3.vandersluis.club/oxide.compiler/{DownloadName}");

//                if (binary != null && File.Exists(binary))
//                {
//                    request.IfModifiedSince = File.GetCreationTimeUtc(binary);
//                    Interface.Oxide.LogInfo($"Validating we have the latest {DownloadName} for .cs (C#) plugin compilation");
//                }
//                else
//                {
//                    Interface.Oxide.LogInfo($"Downloading {DownloadName} for .cs (C#) plugin compilation");
//                }
...
//                {
//                    Interface.Oxide.LogInfo($"Couldn not download {FileName}! Please download manually from: http://umod.cloud/compiler/{DownloadName}");
//                    return;
//                }
...
//            CompilerComment.Add("CS0012", new CS0012());
//        }
...
//                    Interface.Oxide.LogInfo($"Recieved compiled plugins | Length: {result.Data.Length}");
...
//        private static bool HasFrameworkInstalled()
//        {
